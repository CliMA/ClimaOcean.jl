# # Half-degree tripolar ocean–sea ice simulation
#
# Coupled ocean–sea ice simulation on a 0.5° `TripolarGrid` (720×360) with CATKE,
...
ocean.output_writers[:surface] = JLD2Writer(ocean.model, ocean_outputs;
                                            ...
                                            filename = "half_degree_coupled_ocean_surface",
...
sea_ice.output_writers[:fields] = JLD2Writer(sea_ice.model, sea_ice_outputs;
                                             schedule = TimeInterval(5days),
                                             filename = "half_degree_coupled_sea_ice",
                                             overwrite_existing = true)
...
simulation_report(ocean, filename = "half_degree_coupled_report.png")

# ![](half_degree_coupled_report.png)
