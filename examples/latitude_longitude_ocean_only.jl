# # Latitude-longitude ocean simulation
#
# Ocean-only simulation on a 1° `LatitudeLongitudeGrid` (360×150, 75°S–75°N)
...
ocean.output_writers[:surface] = JLD2Writer(ocean.model, outputs;
                                            ...
                                            filename = "latlon_ocean_only_surface",
...
simulation_report(ocean, filename = "latlon_ocean_only_report.png")

# ![](latlon_ocean_only_report.png)
