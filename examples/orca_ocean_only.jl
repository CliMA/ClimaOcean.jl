# # ORCA ocean simulation
#
# Ocean-only simulation on a NEMO eORCA1 mesh with CATKE, Gent-McWilliams,
# and biharmonic viscosity. Forced by repeat-year JRA55 atmospheric
# reanalysis and run for two years.
...
ocean.output_writers[:surface] = JLD2Writer(ocean.model, outputs;
                                            ...
                                            filename = "orca_ocean_only_surface",
...
simulation_report(ocean, filename = "orca_ocean_only_report.png")

# ![](orca_ocean_only_report.png)
