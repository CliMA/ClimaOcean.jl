...
Tsp = FieldTimeSeries(filename_diagnostic, "Ts")
Qvp  = FieldTimeSeries(filename_diagnostic, "Qv")
Qcp  = FieldTimeSeries(filename_diagnostic, "Qc")
Jsp  = FieldTimeSeries(filename_diagnostic, "Js")
Evp  = FieldTimeSeries(filename_diagnostic, "E")
...
lines!(axu, times, interior(up, 1, 1, Nz, :), color=colors[1], linestyle = :dashed, label="Zonal")
lines!(axu, times, interior(vp, 1, 1, Nz, :), color=colors[2], linestyle = :dashed, label="Meridional")
lines!(axu, times, ud★, color=colors[3], label="Ocean-side u★") 
lines!(axu, times, up★, color=colors[3], label="Ocean-side u★", linestyle = :dashed) 
...
lines!(axτ, times, interior(ρτxp, 1, 1, 1, :), linestyle=:dashed, label="Zonal")
lines!(axτ, times, interior(ρτyp, 1, 1, 1, :), linestyle=:dashed, label="Meridional")
...
lines!(axT, times, interior(Tsp, 1, 1, 1, :), color=colors[2], linewidth=4, linestyle = :dashed, label="Ocean surface temperature")
...
lines!(axQ, times, - interior(Qswd, 1, 1, 1, 1:Nt), color=colors[4], label="Shortwave", linewidth=2)
lines!(axQ, times, - interior(Qlwd, 1, 1, 1, 1:Nt), color=colors[5], label="Longwave",  linewidth=2)
lines!(axQ, times, interior(Qvp, 1, 1, 1, 1:Nt),    color=colors[2], linestyle=:dashed, label="Sensible",  linewidth=2)
lines!(axQ, times, interior(Qcp, 1, 1, 1, 1:Nt),    color=colors[3], linestyle=:dashed, label="Latent",    linewidth=2)
lines!(axQ, times, - interior(Qswp, 1, 1, 1, 1:Nt), color=colors[4], linestyle=:dashed, label="Shortwave", linewidth=2)
lines!(axQ, times, - interior(Qlwp, 1, 1, 1, 1:Nt), color=colors[5], linestyle=:dashed, label="Longwave",  linewidth=2)
vlines!(axQ, tn, linewidth=4, color=(:black, 0.5))
axislegend(axQ)

lines!(axF, times, Ptd[1:Nt],                      label="Prescribed freshwater flux")
lines!(axF, times, - interior(Evd, 1, 1, 1, 1:Nt), label="Evaporation")
lines!(axF, times, Ptd[1:Nt],                      linestyle=:dashed, label="Prescribed freshwater flux")
lines!(axF, times, - interior(Evd, 1, 1, 1, 1:Nt), linestyle=:dashed, label="Evaporation")
...
scatterlines!(axuz, upn,  zc, linestyle=:dashed, label="u") 
scatterlines!(axuz, vpn,  zc, linestyle=:dashed, label="v") 
scatterlines!(axTz, Tpn,  zc, linestyle=:dashed) 
scatterlines!(axSz, Spn,  zc, linestyle=:dashed) 
scatterlines!(axez, epn,  zc, linestyle=:dashed) 
scatterlines!(axNz, Np²n, zf, linestyle=:dashed) 
scatterlines!(axκz, κpn,  zf, linestyle=:dashed) 
