...
- `surface_averaging_interval`: averaging window for surface output. Default: `15days`.
- `field_averaging_interval`: averaging window for 3-D output. Default: `15days`.
...
function add_omip_diagnostics!(simulation;
    ...
    # ===================================================================
    # 4. Transport diagnostics (opt-in)
    # ===================================================================
    if transports
    ...
    # ===================================================================
    # 5. Scalar / zonal-mean diagnostics (callback-based)
    # ===================================================================
