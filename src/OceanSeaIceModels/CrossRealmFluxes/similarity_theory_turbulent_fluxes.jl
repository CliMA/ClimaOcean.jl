...
@inline function update_turbulent_flux_fields!(fields, i, j, grid, fluxes, ρᶠ)
    Qw = fields.latent_heat
    ...
    @inbounds begin
        # +0: cooling, -0: heating
        Qw[i, j, 1] = ifelse(inactive, 0, fluxes.latent_heat)
        ...
        Fvᵢ = fluxes.freshwater / ρᶠ # convert to volume flux
