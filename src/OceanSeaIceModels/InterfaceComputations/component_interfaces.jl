...
function sea_ice_ocean_interface(sea_ice::SeaIceSimulation, ocean;
                                 characteristic_melting_speed = 1e-3)
...
function ComponentInterfaces(atmosphere, ocean, sea_ice=nothing;
                             ...
                             atmosphere_sea_ice_flux_formulation = SimilarityTheoryFluxes(stability_functions=atmosphere_sea_ice_stability_functions()),
